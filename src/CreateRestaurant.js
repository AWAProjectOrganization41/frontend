    ...
    return(
       ...
       <div>
           ...
           <section>
               ...
               <input type="text" name="hours" id="hours" onChange= { e => setRestaurant({ hours: e.target.value})} value={restaurant.hours}></input>
               <br/><br/>
           ...
           <Link to="createmenu"><button> Done </button></Link>
